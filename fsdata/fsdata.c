...
const struct fsdata_file file_index_ssi[] = {{file_404_html,
					      data_index_ssi, data_index_ssi + 11,
					      sizeof(data_index_ssi) - 11,
					      1}};

const struct fsdata_file file_websockets_html[] = {{file_index_ssi,
						    data_websockets_html, data_websockets_html + 17,
						    sizeof(data_websockets_html) - 17,
						    1}};

const struct fsdata_file file_js_smoothie_min_js[] = {{file_websockets_html,
						       data_js_smoothie_min_js, data_js_smoothie_min_js + 20,
						       sizeof(data_js_smoothie_min_js) - 20,
						       1}};

const struct fsdata_file file_css_siimple_min_css[] = {{file_js_smoothie_min_js,
							data_css_siimple_min_css, data_css_siimple_min_css + 21,
							sizeof(data_css_siimple_min_css) - 21,
							1}};

const struct fsdata_file file_css_style_css[] = {{file_css_siimple_min_css,
						  data_css_style_css, data_css_style_css + 15,
						  sizeof(data_css_style_css) - 15,
						  1}};

const struct fsdata_file file_about_html[] = {{file_css_style_css,
					       data_about_html, data_about_html + 12,
					       sizeof(data_about_html) - 12,
					       1}};

const struct fsdata_file file_img_favicon_png[] = {{file_about_html,
